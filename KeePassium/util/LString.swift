...
public enum LString {
    ...
    // Deletion
//    public static let confirmDeleteAreYouSure = NSLocalizedString(
//        "[Generic/ConfirmDelete/title] Are you sure?",
//        value: "Are you sure?",
//        comment: "Message to confirm deletion of an item.")
...
//    public static let discardChangesConfirmation = NSLocalizedString(
//        "[Generic/Edit/Aborting/text] Discard unsaved changes?",
//        value: "Discard unsaved changes?",
//        comment: "Notification text when the user tries to close a document with unsaved changes"
//    )
...
//    public static let titleChooseFileToOpen  = NSLocalizedString(
//        "Choose Database",
//        comment: "Title of a window where the user selects a file to be opened/added to the app")
...
//    public static let actionImportDatabase = NSLocalizedString(
//        "Import Database", comment: "Action/button")
