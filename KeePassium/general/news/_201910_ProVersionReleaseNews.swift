...
class _201910_ProVersionReleaseNews: NewsItem {
    ...
    var isCurrent: Bool {
        if BusinessModel.type == .prepaid {
            return false // Don't show Pro news to Pro users :)
        }
    ...
    #if MAIN_APP
    private var premiumCoordinator: PremiumCoordinator? // keeps a strong ref to premiumCoordinator
    #endif
    ...
    func show(in viewController: UIViewController) {
        ...
        self.premiumCoordinator = premiumCoordinator // keep coordinator from deallocation
