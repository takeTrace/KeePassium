...
//  KeePassium
//
//  Created by Andrei Popleteev on 2018-07-03.
...
class PasswordGeneratorVC: UITableViewController, Refreshable {
    ...
    func refresh() {
        ...
        guard gotChars else {
            // we have no characters to create the password from
            password = ""
            passwordLabel.text = " " // whitespace to prevent vertical collapsing
            return
        }
