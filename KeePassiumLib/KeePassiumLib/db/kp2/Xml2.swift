...
/// Common XML-related constants for KP2 database
internal struct Xml2 {
    enum ParsingError: LocalizedError {
        //TODO: refactor: remove/combine redundant errors
        case xmlError(details: String) // generic error of the XML parser
        case notKeePassDocument
        /// Got something unexpected
        case unexpectedTag(actual: String, expected: String?)
        /// Got an empty or misformatted tag value
    ...
    static let defaultAutoTypeSequence = "DefaultAutoTypeSequence" // for groups
    ...
    static let defaultSequence = "DefaultSequence" // for entries
    ...
    static let null = "null" // lower case
}
